...
public class DonaldDuck extends Serie {

	public static final String CHAPTER_URL = URL + "donald-duck/";

	private static final String JSON_FILE = "donald-duck-eng.json";

	public DonaldDuck(final Activity activity) {
		super();
